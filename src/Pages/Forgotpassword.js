            ...
            <div className='container'>
                <div className='reset-pass'>
                    ...
                    <div className='rest-txt'>
                      ...
                      <p>Your password must be different fron previous used password</p>
                    </div>
                    <div className='form-col'>
                      <form className='forgot-pass'>
                        <div className='p-f-field'>
                          <label>Password</label>
                          <input type="/" className="forgot-input" placeholder='Enter New password'/> 
                        ...
                        <div className='confirm-pass'>
                          ...
                          {/* <span className='password-alert'>Must be at 8 ch</span> */}
                        </div>
                        <Link to="">
